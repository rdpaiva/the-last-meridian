  ...
  return [
    ...
    },
    {
      ...
      lines: [
        ...
        `Seekers can also be <b>shot down</b> — a cannon bolt that passes close enough detonates one mid-flight. Gunship rounds pack a blast radius ×${GameConfig.missile.heavyInterceptScale} wider: in a Breaker or Reaver you won't out-turn a missile, so turning into it and hosing it <i>is</i> your dodge.`,
    ...
    },
    {
      ...
      lines: [
        ...
        `A gunship can't dodge a seeker — but its heavy rounds have the blast to swat one. Get the nose on the inbound missile and fire: point defense is the big hulls' evasive maneuver.`,
    ...
    },
    {
      ...
      lines: [
        ...
        `A pulsing red border and a quickening beep is the <b>missile warning</b>: a seeker is homing on you. Break hard and outlast its motor — or, in a gunship, turn in and shoot it down.`,
