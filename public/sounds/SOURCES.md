...
All sound effects in this directory are sourced from [freesound.org](https://freesound.org)
under the **Creative Commons 0 (CC0)** license. Under CC0, no attribution is
required for use — but it's still credited here as a courtesy to the authors.
