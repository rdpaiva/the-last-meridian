...
| `cannon.mp3`       | — (project asset)                                                       | project owner | project asset | ~1s heavy cannon report for carrier defense turrets; provided as WAV, converted to MP3 via ffmpeg (`-qscale:a 4`) |
